...
<body>
    ...
    function send_email_verify($email)
    {
        ...
        $body = "click the below link for reset the password <a href='http://localhost/ipa/forgotpassword.php?email=$email'>Reset Password</a>";
        $mail->Body    = $body;
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 my-4 ml-4 text-right">
                ...
                <a class="mx-3" href="index.php">already registered</a>
