...
<html lang="de">
    <head>
      <title>Admin Resetpassword Aufgaben Erfassungstool</title>
    ...
    function send_email_verify($fname, $email, $verifyToken)
    {
        ...
        try{
            ...
            $body = "<p style= color:#000048; font-size: 20px;><b>Welcome to Aufgabenerfassungstool E-Mail verifikation</b></p>
                    ...
                    click the below link for verify the account <a href= 'http://localhost/ipa/verify-email.php?email=$email';>Admin Verify Email</a>
       ...
       $email=$_POST['email'];
        ...
        if (empty( $pw_validation_error|| $pw_error || $samepw_error)) {
            ...
            if ($query_run) {
                ...
                $_SESSION['name'] = "hi";
                // redirect to adminlogin file
                header("Location:adminLogin.php");

               // make the email field empty after successfull reset password
                $email = "";
                exit();
            }
        }
...
<div class="row my-5">
            ...
            <!-- set a heading in admin resetpassword -->
                <h2 class="cognizant">Admin Reset password</h2>
            </div>
        </div>
        ...
        <div class="col-12 py-3">
            ...
            <div class="text-center col-lg-6 col-md-12 col-sm-12 py-3" id="passwordmessage"></div> -->
